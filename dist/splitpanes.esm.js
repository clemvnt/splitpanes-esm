import { h, openBlock, createBlock, renderSlot } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", {
    ...
    onClick: _cache[1] || (_cache[1] = $event => ($options.onPaneClick($event, _ctx._.uid))),
    style: _ctx.style
  }, [
...
export { script$1 as Pane, script as Splitpanes };
